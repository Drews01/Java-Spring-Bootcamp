...
/**
 * Utility class for creating and managing HttpOnly cookies.
 * Used for secure JWT storage in cookies instead of localStorage.
 */
public final class CookieUtil {
     ...
     * @param secure        whether to set Secure flag (true for HTTPS, false for
     *                      local dev)
    ...
    /**
     * Creates a cookie to clear the JWT (for logout).
