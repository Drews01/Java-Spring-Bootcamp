...
/**
 * Standard API Response wrapper untuk semua endpoint
 * Memberikan format response yang konsisten
 */
@Data
@Builder
@NoArgsConstructor
...
public class ApiResponse<T> {
     ...
     */
    public static <T> ApiResponse<T> error(String message, ErrorDetails errorDetails, Integer statusCode) {
        return ApiResponse.<T>builder()
                .success(false)
                .message(message)
                .error(errorDetails)
