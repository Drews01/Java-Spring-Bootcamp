...
/**
 * JWT Authentication Filter that reads JWT from cookies.
 * Falls back to Authorization header for backward compatibility.
 * 
 * <p>
 * Processing order:
 * 1. Check for JWT in HttpOnly cookie
 * 2. If not found, check Authorization: Bearer header
...
public class JwtCookieAuthenticationFilter extends OncePerRequestFilter {
    ...
    /**
     * Checks if the request path is a public endpoint that doesn't require
     * authentication.
     */
