...
public class UserProductService {
    ...
    public UserProductDTO createUserProduct(UserProductDTO dto) {
        ...
        userProductRepository.findByUser_IdAndProduct_Id(dto.getUserId(), dto.getProductId())
                .ifPresent(up -> {
                    throw new RuntimeException("UserProduct already exists for user " + dto.getUserId()
                            + " and product " + dto.getProductId());
                });
    ...
    public UserProductDTO getUserProduct(Long userProductId) {
        UserProduct userProduct = userProductRepository.findById(userProductId)
                .orElseThrow(() -> new RuntimeException("UserProduct not found with id: " + userProductId));
