...
public class LoanHistoryController {
  ...
  @PostMapping
  public ResponseEntity<ApiResponse<LoanHistoryDTO>> createLoanHistory(
      @RequestBody LoanHistoryDTO dto) {
  ...
  public ResponseEntity<ApiResponse<LoanHistoryDTO>> getLoanHistory(
